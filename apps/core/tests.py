...
class AccessibleSubmodulesTests(SimpleTestCase):
    @patch("apps.core.permissions._get_role_permissions_cache", return_value={("reimburse", None): {"can_view": True, "can_create": True, "can_edit": False, "can_delete": False}, ("reimburse", "reimburse"): {"can_view": True, "can_create": True, "can_edit": False, "can_delete": False}})
