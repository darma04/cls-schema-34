...
class RolePermission(models.Model):
    ...
    SUB_MODULE_TO_SLUG = {
        ...
        # Sidebar slugs: service-center-pelanggan, service-center-order, dsb
        # extract_submodule('service-center-pelanggan') → 'pelanggan'
        # extract_submodule('service-center-order') → 'order'
        'dashboard': 'dashboard',          # sidebar: service-center-dashboard → extract → 'dashboard'
        'order_service': 'order',           # sidebar: service-center-order → extract → 'order'
        'pelanggan_sc': 'pelanggan',        # sidebar: service-center-pelanggan → extract → 'pelanggan'
        'perangkat': 'perangkat',           # sidebar: service-center-perangkat → extract → 'perangkat'
        'kategori_service': 'kategori',     # sidebar: service-center-kategori → extract → 'kategori'
        'jenis_service': 'jenis',           # sidebar: service-center-jenis → extract → 'jenis'
        'terima_unit': 'terima',            # sidebar: service-center-terima → extract → 'terima'
        'sc_laporan': 'laporan',            # sidebar: service-center-laporan → extract → 'laporan'
        # === Sparepart ===
